...
let ChatClient = ChatClient_1 = class ChatClient extends ircv3_1.IrcClient {
    ...
    constructor(config = {}) {
        ...
        this.onTypedMessage(ClearChat_1.ClearChat, msg => {
        ...
        this.onTypedMessage(ircv3_1.MessageTypes.Commands.Notice, async ({ params: { target: channel, content }, tags }) => {
            ...
            switch (messageType) {
                ...
                case 'bad_ban_broadcaster': {
                    this.emit(this._onBanResult, channel, (0, userUtil_1.toUserName)(channel), messageType);
                    break;
                }
                case 'bad_ban_admin':
                ...
                case 'bad_timeout_broadcaster': {
                    this.emit(this._onTimeoutResult, channel, (0, userUtil_1.toUserName)(channel), undefined, messageType);
                    break;
                }
                case 'bad_timeout_mod': {
                    const match = /^You cannot timeout moderator (\w+) unless/.exec(content);
                    if (match) {
                        this.emit(this._onTimeoutResult, channel, (0, userUtil_1.toUserName)(match[1]), undefined, messageType);
                    }
                    break;
                }
    ...
    async host(channel, target) {
        const channelName = (0, userUtil_1.toUserName)(channel !== null && channel !== void 0 ? channel : this._credentials.nick);
        await new Promise((resolve, reject) => {
            const e = this._onHostResult((chan, error) => {
                if ((0, userUtil_1.toUserName)(chan) === channelName) {
                    if (error) {
                        reject(error);
                    }
                    else {
    ...
    async unhost(channel = this._credentials.nick) {
        channel = (0, userUtil_1.toUserName)(channel);
        await new Promise((resolve, reject) => {
            const e = this._onUnhostResult((chan, error) => {
                if ((0, userUtil_1.toUserName)(chan) === channel) {
                    if (error) {
                        reject(error);
                    }
                    else {
    ...
    async raid(channel, target) {
        target = (0, userUtil_1.toUserName)(target);
    ...
    async ban(channel, user, reason = '') {
        const channelName = (0, userUtil_1.toUserName)(channel !== null && channel !== void 0 ? channel : this._credentials.nick);
        user = (0, userUtil_1.toUserName)(user);
        await new Promise((resolve, reject) => {
            const e = this._onBanResult((_channel, _user, error) => {
                if ((0, userUtil_1.toUserName)(_channel) === channelName && (0, userUtil_1.toUserName)(_user) === user) {
                    if (error) {
                        reject(error);
                    }
                    else {
    ...
    async clear(channel = this._credentials.nick) {
        ...
        await new Promise(resolve => {
            const e = this.addInternalListener(this.onChatClear, _channel => {
                if ((0, userUtil_1.toUserName)(_channel) === channel) {
                    resolve();
                    e.unbind();
                }
            });
    ...
    async deleteMessage(channel, message) {
        channel = (0, userUtil_1.toUserName)(channel);
        const messageId = (0, ChatMessageAttributes_1.extractMessageId)(message);
        await new Promise((resolve, reject) => {
    ...
    async enableFollowersOnly(channel, minFollowTime = 0) {
        ...
        await new Promise((resolve, reject) => {
            const e = this._onFollowersOnlyResult((_channel, _minFollowTime, error) => {
                if ((0, userUtil_1.toUserName)(_channel) === channel && _minFollowTime === minFollowTime) {
                    if (error) {
                        reject(error);
                    }
                    else {
    ...
    async mod(channel, user) {
        ...
        await new Promise((resolve, reject) => {
            const e = this._onModResult((_channel, _user, error) => {
                if ((0, userUtil_1.toUserName)(_channel) === channel && (0, userUtil_1.toUserName)(_user) === user) {
                    if (error) {
                        reject(error);
                    }
                    else {
     ...
     */
    async enableUniqueChat(channel) {
        channel = (0, userUtil_1.toUserName)(channel);
        await new Promise((resolve, reject) => {
     ...
     */
    async disableUniqueChat(channel) {
        channel = (0, userUtil_1.toUserName)(channel);
        await new Promise((resolve, reject) => {
    ...
    async addVip(channel, user) {
        ...
        await new Promise((resolve, reject) => {
            const e = this._onVipResult((_channel, _user, error) => {
                if ((0, userUtil_1.toUserName)(_channel) === channel && (_user === undefined || (0, userUtil_1.toUserName)(_user) === user)) {
                    if (error) {
                        reject(error);
                    }
                    else {
     ...
     */
    async announce(channel, message) {
     ...
     */
    async say(channel, message, attributes = {}, rateLimiterOptions) {
        const tags = {};
     ...
     * @param rateLimiterOptions Options to pass to the rate limiter.
     */
    async action(channel, message, rateLimiterOptions) {
        await this._messageRateLimiter.request({
            type: 'action',
            channel: (0, userUtil_1.toChannelName)(channel),
            message
...
Please note that your whispers might not arrive reliably if your bot is not a known or verified bot.`);
        ...
        await this._whisperRateLimiter.request({
            target: (0, userUtil_1.toUserName)(user),
            message
        });
    }
    /**
     ...
     */
    part(channel) {
        super.part((0, userUtil_1.toChannelName)(channel));
    }
    /**
