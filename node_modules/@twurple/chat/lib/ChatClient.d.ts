...
export declare class ChatClient extends IrcClient {
     ...
     * @param message The message text.
     */
    readonly onAuthenticationFailure: EventBinder<[message: string, retryCount: number]>;
    /**
     ...
     */
    say(channel: string, message: string, attributes?: ChatSayMessageAttributes, rateLimiterOptions?: RateLimiterRequestOptions): Promise<void>;
    /**
     ...
     * @param rateLimiterOptions Options to pass to the rate limiter.
     */
    action(channel: string, message: string, rateLimiterOptions?: RateLimiterRequestOptions): Promise<void>;
    /**
