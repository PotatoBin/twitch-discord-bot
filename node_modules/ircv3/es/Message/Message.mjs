...
var Message = /** @class */ (function () {
    ...
    Object.defineProperty(Message.prototype, "paramCount", {
        get: function () {
            var _a, _b;
    ...
    Message.prototype.toString = function (includePrefix) {
        ...
        var specKeys = cls.PARAM_SPEC ? Object.keys(cls.PARAM_SPEC) : [];
    ...
    Object.defineProperty(Message.prototype, "rawParamValues", {
        get: function () {
            var _a, _b;
            return (_b = (_a = this._params) === null || _a === void 0 ? void 0 : _a.map(function (param) { return param.value; })) !== null && _b !== void 0 ? _b : [];
        },
        enumerable: false,
        configurable: true
    });
